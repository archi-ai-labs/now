...
| Hỏi | Xem |
|---|---|
| App làm gì, chạy sao, bảy màn có gì | [../README.vi.md](../README.vi.md) |
| Vì sao thiết kế/chart trông thế này | [DESIGN.vi.md](DESIGN.vi.md) |
| Kiến trúc, nguồn đọc, bản đồ file, cạm bẫy | [ARCHITECTURE.vi.md](ARCHITECTURE.vi.md) |
